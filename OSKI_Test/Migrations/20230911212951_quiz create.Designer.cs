...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OSKI_Test.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OSKI_Test.Models.TrueAnswer", b =>
                {
                    ...
                    b.HasKey("QuizId", "QuestionId", "OptionId");

                    b.HasIndex("OptionId");

                    b.HasIndex("QuestionId");

                    b.ToTable("AnswerToQuestion");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OSKI_Test.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OSKI_Test.Models.QuizToUser", b =>
                {
                    ...
                    b.HasOne("OSKI_Test.Models.Quiz", "Quiz")
                        .WithMany()
                        .HasForeignKey("QuizId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OSKI_Test.Models.TrueAnswer", b =>
                {
                    b.HasOne("OSKI_Test.Models.Option", "Option")
                        .WithMany()
                        .HasForeignKey("OptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OSKI_Test.Models.Question", "Question")
                        .WithMany()
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
